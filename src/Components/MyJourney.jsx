...
const Timeline = () => {
  return (
    <div className="flex flex-col items-center bg-gray-800 text-white py-10 px-4">
      <h3 className="text-4xl font-bold mb-6 text-center">My Journey</h3>
      <h1 className="text-xl text-gray-400 mb-6 text-center">Education and Work Experience</h1>
